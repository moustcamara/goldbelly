...
const Header = props => (
		...
		<header className="site-header">
			<div className="container">
				<Logo title="Goldbelly" />

				<div className="site-header__minicart">
					<a href="#" onClick={props.actions.toggleCart}>
						<span className="site-header__minicart-count">{props.cartInfo.length ? props.cartInfo.length : ""}</span>
						<svg className="site-header__minicart-icon" viewBox="0 0 32 32" width="24px" height="24px">
							<title>cart</title>
